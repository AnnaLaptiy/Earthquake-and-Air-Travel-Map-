...
import exceptions.MapInteractiveUtils;
import exceptions.ServerException;
import processing.core.PConstants;
import processing.core.PGraphics;

public abstract class EarthquakeMarkerRequest extends CommonMarkerRequest
{
	...
	// constructor
	public EarthquakeMarkerRequest (PointFeature feature) 
	{
		...
		for(String str:properties.keySet()) {
			...
			MapInteractiveUtils.checkProperty(str);

		}
		for(Object str:properties.values()) {
			MapInteractiveUtils.checkProperty(str);
